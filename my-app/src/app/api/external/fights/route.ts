 ...
 *
 * Debug logs (proxy URL, upstream status, HTML body snippets) were for verifying the
 * Hueman fights proxy. Silenced for local testing — default host returns 404 HTML.
 */
