        ...
        <>
            ...
            >
                ...
                <nav className="flex-1 min-h-0 px-4 py-6 flex flex-col gap-6 overflow-x-hidden">
                    ...
                    {/* Assigned to You — natural height, never stretches */}
                    {(() => {
                    ...
                    {/* Awaiting QC - Videos that need quality control review
                        CHANGED: wrapper is `flex-1 min-h-0 flex flex-col` (fills space, equal share),
                        gets a top divider (`pt-6 border-t border-border`) for clear separation,
                        and the inner list is `flex-1 min-h-0 overflow-y-auto` (was `max-h-40`). */}
                    {(() => {
                    ...
                    {/* QC Complete - Videos that have been reviewed
                        CHANGED: identical treatment to Awaiting QC — fills remaining space equally,
                        top divider for separation, inner list scrolls (`max-h-40` removed). */}
                    {(() => {
