...
const VideoGrid = () => {
    ...
    // ── ADDED: apply assignee filter to the center cards ─────────────────────
    const filteredAssignedVideos = assignedVideos.filter(v => {
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3 mb-6 flex-wrap">
                            ...
                            <span className="ml-auto text-sm text-foreground-tertiary">
                                {filteredAssignedVideos.length} {filteredAssignedVideos.length === 1 ? 'project' : 'projects'}
                            </span>
                        </div>
